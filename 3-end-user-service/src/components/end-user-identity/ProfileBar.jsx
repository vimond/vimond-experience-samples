  ...
  return (
    <>
     <div className='profile-menu-icon' >
        ...
        <button onClick={() => {onClick(); refreshToken()}}>
      ...
      <ul>
        ...
        {isAuthenticated && (
          ...
          <li>
            <div  onMouseUp={showProfile} onClick={onClick}><Icon name='edit' label='My Account' className=''/></div>
          </li>
          <li>
            <div  onClick={() => {showSubProfile();loadSubProfiles()}}><Icon name='edit' label='Switch profile' className=''/></div>
          </li>
