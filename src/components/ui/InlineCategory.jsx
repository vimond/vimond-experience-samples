...
export default class InlineCategory extends Component {
  ...
  loadSeasonAssets = e => {
    ...
    contentDiscoveryAPI.getAssetsFromCategoryId(season.id)
      .then(result => {
        this.setState({seasonAssets: result.data, season: season});
        console.log('calling getAssetsFromCategoryId ', result)
      });
  ...
  onPlay = e => {
    console.log('Play item', e.currentTarget.dataset.id)
  };
