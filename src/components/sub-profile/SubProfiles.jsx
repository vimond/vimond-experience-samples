...
const loadSubProfile = (e) => { initSubProfile(e.target.dataset.id); setTimeout(function () {onClose()}, 500)}
const deleteSubProfile = () => { deletSubProfile(subID); setShowInput(false);}
    ...
    <div className="subProfileCovers" >
        ...
        {subProfiles &&  subProfiles.map(subProfile =>
            <div className="subProfileCover" key={subProfile.subProfileId}  >
              <img alt={subProfile.subProfileName} src={source + subProfile.subProfileName } data-id={subProfile.subProfileId} onClick={loadSubProfile}  /> 
